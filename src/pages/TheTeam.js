      ...
      {members.map((member, i) => (
        <img
          ...
          onClick={() => {
            ...
            if (!isMobileGrid) onMemberClick(member);
          }}
          style={{
            width: cardWidth,
            height: 'auto',
            display: 'block',
            cursor: isMobileGrid ? 'default' : 'pointer',
            ...
            {!isMobile && (
              <motion.div
                ...
                animate={{
                  ...
                  backgroundColor: isSidebarOpen ? 'rgba(20,20,20,0.95)' : 'rgba(255,0,0,0.1)'
                }}
              ...
              >
                {!isSidebarOpen ? (
                  ...
                  <div style={{ padding: '30px 20px', height: '100%', display: 'flex', flexDirection: 'column', boxSizing: 'border-box', minWidth: '320px' }}>
                    <h4 style={{
                      color: 'white',
                      fontFamily: "'Hunters', sans-serif",
                      letterSpacing: '2px',
